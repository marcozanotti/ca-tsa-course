...
```{r}
train_dtt <- ymd_hms(c("2009-07-01 00:00:00", "2011-01-01 00:00:00")) # train period
...
```{r}
Sys.setenv(JAVA_HOME = "/usr/lib/jvm/jdk-17/") # set your specific jvm path
...
write_csv(res$forecast_tbl, "marcozanotti_forecasts.csv")
write_csv(res$evaluation_tbl, "marcozanotti_metrics.csv")
```
